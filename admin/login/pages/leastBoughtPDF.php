<?php
	function fetch_data(){
		...
		$categoryData = "SELECT order_name, sum(quantity) as quantity from transaction group by order_name order by quantity asc limit 10";
...
date_default_timezone_set("Asia/Singapore");
	if(isset($_POST['generate_pdf'])){
		...
		$obj_pdf->AddPage();
		$content='';
		$content.= '<h3 align = "center"><i>Naughty Nachos Maginhawa - Top 10 Least Bought Products</i></h3><br/>
