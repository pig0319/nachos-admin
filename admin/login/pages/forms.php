...
//ITO YUNG PARA SA NEW EMPLOYEE
                                        ...
                                        if(isset($_POST['submit'])){
                                            ...
                                            if($password!=$conf){
                                                ...
                                                $check = mysqli_query($connections,"SELECT * from users where userid = '$userID'");
                                                ...
                                                if(is_array($row)){
                                                    ...
                                                    $get = mysqli_query($connections, "SELECT id from users order by id desc limit 1");

                                                    while( $fetch = mysqli_fetch_array($get)){
                                                        $out = $fetch['id'];
                                                    }
                                                    $subfirst = substr($firstname,0,1);

                                                    $userID = "qcmag"."_". $subfirst . $lastname . (1+$out);
                                                    $userShow = $userID;
...
<head>
    ...
    <script>
        function currDate(){
            var dt = new Date();
            document.getElementById("currDate").value = dt.toDateString();
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form role="form" method = "POST" action = "">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type = "text" name = "username" value = "<?php if($userShow != ""){ echo $userShow; }else{ echo "Not set yet.";}?>" disabled>
                                            <p class="help-block">Employee's username</p>
                                        </div>
                                        <div class="form-group">
                                            <span style = "color: red;"><?php if($message !=""){echo $message;}?></span><br><br>
                                            <label>First Name</label>
                                            <input class="form-control" type = "text" name = "firstname" value = "<?php if($firstname != ""){ echo $firstname; }?>" required>
                                            <p class="help-block">Employee's first name</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Middle Name</label>
                                            <input class="form-control" type = "text" name = "middlename" value = "<?php if($middlename != ""){ echo $middlename; }?>"  required>
                                            <p class="help-block">Employee's middle name</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Last Name</label>
                                            <input class="form-control" type = "text" name = "lastname" value = "<?php if($lastname != ""){ echo $lastname; }?>" required>
