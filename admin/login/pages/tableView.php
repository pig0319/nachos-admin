                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                           <form name = "create" method = "POST" action = "newMenu.php">
                                                            <?php
                                                              $connections = mysqli_connect("localhost","root","","nachos");
                                                               $query = mysqli_query($connections," select product_id from nachosmenu order by product_id desc limit 1 ");
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        $query = mysqli_query($connections,"SELECT product_id from nachosmenu");
